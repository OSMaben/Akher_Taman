                    ...
                    <div class="card border-light-subtle shadow-sm">
                        <div class="row g-0">
                            <div class="col-12 col-md-6">
                                <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="images/bg/live-auc1.png" alt="Welcome back you've been missed!">
                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-5">
                                                    <div class="text-center mb-4">
                                                        <a href="#!">
                                                            <img src="images/bg/header-logo2.png" alt="BootstrapBrain Logo" width="175" height="57">
                                                        </a>
                                                    </div>
...
{{--                                        </p>--}}
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            ...
                                            <div class="row gy-3 overflow-hidden">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-floating mb-3">
                                                        <input type="password" class="form-control" name="c_password" id="password"  placeholder="Password" >
